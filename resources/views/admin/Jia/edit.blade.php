...
@section('content')
    ...
    <div class="result_wrap">
        <form action="{{url('admin/jia/'.$field->jia_id)}}" method="post">
            ...
            <table class="add_tab">
                ...
                <tr>
                    <th>姓名：</th>
                    <td>
                        <input type="text" class="xs" name="jia_name" value="{{$field->jia_name}}">
                    </td>
                </tr>
                ...
                {{--<tr>--}}
                    ...
                    {{--<td>--}}
                        {{--<input class="laydate-icon" name="jia_date" onclick="laydate({istime: true, format: 'YYYY-MM'})"  placeholder="选择日期" value="{{date('Y-m',$field->jia_date)}}">--}}
                        {{--选择年月即可--}}
                    {{--</td>--}}
                {{--</tr>--}}
                <tr>
                    <th><i class="require"></i>加班小时数：</th>
                    <td>
                        <input type="text" name="jia_hour" onchange="checkNum(this)" value="{{$field->jia_hour}}">
                    </td>
                </tr>
                <tr>
                    <th></th>
